                ...
                <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                    <div>
                        <h1
                            ...
                            Access Health Care at your fingers tips <span class="text-blue-600">Book an
                                Appointment</span></h1>
                        <p class="mt-3 text-lg text-gray-800 dark:text-neutral-400">Wlcome, your one-stop solution for
                            managing your health. Wheather you need a quick consultation or a routine check-up, our app
                            lets you book appointments with top-rated doctors at your convenience. Say goodbye to long
                            waits and hello to seamless health care.</p>
                    ...
                    <div class="relative ms-4">
                        <img class="w-full rounded-md" src="{{asset('doctor_image.jpg')}}" alt="Hero Image">
                        <div
